...
const { testBananasDevWinDoneTwice } = require('../assertions/bananagrams_solo_done');
...
async function runBananagramsSpMobile(page) {
    ...
    const { assertMobileSoloSettingsResetMatchesRefresh } = require('../assertions/bananagrams_mobile_default_viewport_assertions');
    ...
    const { assertBananagramsRackVisibleWithLowPersistedZoom } = require('../assertions/bananagrams_hub_layout');
    ...
    const { runSoloFullGameAudit } = require('../scenarios/solo-ui-actions');
