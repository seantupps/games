...
const { runMpPeelSpawnSyncAudit } = require('../../fixtures/peel-grid');
...
async function runMpPeelSpawnScenario(opts) {
    ...
    if (mobile && process.env.FIVE_MP_MOBILE_TILE_STABILITY === '1') {
        const { runBananagramsMpMobilePeelDumpTileStability } = require('../../scenarios/mp/layout-stability-mobile');
